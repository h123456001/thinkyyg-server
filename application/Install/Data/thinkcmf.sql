...
CREATE TABLE IF NOT EXISTS `yyg_ad` (
...
CREATE TABLE IF NOT EXISTS `yyg_asset` (
...
CREATE TABLE IF NOT EXISTS `yyg_comments` (
...
-- 
-- 表的结构 `yyg_common_action_log`
-- 

CREATE TABLE IF NOT EXISTS `yyg_common_action_log` (
...
CREATE TABLE IF NOT EXISTS `yyg_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `yyg_links` (
...
CREATE TABLE IF NOT EXISTS `yyg_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `yyg_nav_cat` (
...
CREATE TABLE IF NOT EXISTS `yyg_oauth_user` (
...
INSERT INTO `yyg_terms` VALUES (1, '列表演示', '', 'article', '', 0, 0, '0-1', '', '', '', 'list', 'article', 0, 1);
INSERT INTO `yyg_terms` VALUES (2, '瀑布流', '', 'article', '', 0, 0, '0-2', '', '', '', 'list_masonry', 'article', 0, 1);
...
-- 
-- 表的结构 `yyg_user_favorites`
-- 

CREATE TABLE IF NOT EXISTS `yyg_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `yyg_links` VALUES (1, 'http://www.thinkyyg.com', 'ThinkYYG', '', '_blank', '', 1, 0, '', 0);
...
INSERT INTO `yyg_nav` VALUES (1, 1, 0, '首页', '', 'home', '', 1, 0, '0-1');
INSERT INTO `yyg_nav` VALUES (2, 1, 0, '列表演示', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"1";}}', '', 1, 0, '0-2');
INSERT INTO `yyg_nav` VALUES (3, 1, 0, '瀑布流', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"2";}}', '', 1, 0, '0-3');
...
INSERT INTO `yyg_nav_cat` VALUES (1, '主导航', 1, '主导航');